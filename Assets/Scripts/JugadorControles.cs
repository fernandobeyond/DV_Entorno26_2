...
//     version 1.18.0
//     from Assets/JugadorControles.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/JugadorControles.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @JugadorControles: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @JugadorControles()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""JugadorControles"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@JugadorControles()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, JugadorControles.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, JugadorControles.UI.Disable() has not been called.");
    }
    ...
    {
        private @JugadorControles m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@JugadorControles wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@JugadorControles wrapper) { m_Wrapper = wrapper; }
        /// <summary>
